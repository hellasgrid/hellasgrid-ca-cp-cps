...
There is one off-site backup of the private key of the CA at the GRNET S.A. headquarters. The backup is kept encrypted both in digital and printed on paper formats, in a tamper-evident envelope, in a fire‐proof safe to which only the GRNET CTO has access.
